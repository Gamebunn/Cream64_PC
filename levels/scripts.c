...
const LevelScript level_main_scripts_entry[] = {
    ...
    //LOAD_MODEL_FROM_GEO(MODEL_MARIO_DAWN_FLY,          mario_dawn_fly_geo),
    //LOAD_MODEL_FROM_GEO(MODEL_MARIO_SERENA_FLY,        mario_serena_fly_geo),
    ...
    //LOAD_MODEL_FROM_GEO(ODEL_CHEESE_FOLLOW_DAWN,        cheese_follow_dawn_geo),
    //LOAD_MODEL_FROM_GEO(ODEL_CHEESE_FOLLOW_SERENA,      cheese_follow_serena_geo),
    //LOAD_MODEL_FROM_GEO(ODEL_CHEESE_FOLLOW_MIKU,        cheese_follow_miku_geo),
    //LOAD_MODEL_FROM_GEO(ODEL_CHEESE_FOLLOW_MAGE,        cheese_follow_mage_geo),
    //LOAD_MODEL_FROM_GEO(ODEL_CHEESE_FOLLOW_WONDER,      cheese_follow_wonder_geo),
    //LOAD_MODEL_FROM_GEO(ODEL_CHEESE_FOLLOW_DENJI,       cheese_follow_denji_geo),
    //LOAD_MODEL_FROM_GEO(ODEL_CHEESE_FOLLOW_JOHNNY,      cheese_follow_johnny_geo),
