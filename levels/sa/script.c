...
const LevelScript level_sa_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_TREE_MS_NM, ms_tree_nm_geo),
	LOAD_MODEL_FROM_GEO(MODEL_GREMLIN_NM, gremlin_nm_geo),
	LOAD_MODEL_FROM_GEO(MODEL_SCUTTLEBUG_NM, skeeter_nm_geo),
    ...
    AREA(2, sa_area_2),
		...
		WARP_NODE(0x01, LEVEL_SA, 0x04, 0x02, WARP_NO_CHECKPOINT),
		WARP_NODE(0x02, LEVEL_SA, 0x04, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, -6287, 342, -2535, 0, 0, 0, 0x00010000, bhvWarp),
		OBJECT(MODEL_NONE, -6287, 342, -2662, 0, 0, 0, 0x00010000, bhvWarp),
		OBJECT(MODEL_NONE, -6287, 342, -2406, 0, 0, 0, 0x00010000, bhvWarp),		
	...
	AREA(3, sa_area_3),
		...
		OBJECT(MODEL_NONE, -5508, -7501, 4237, 0, 0, 0, 0x00000000, bhvBMMusic2),
		OBJECT(MODEL_NONE, -5508, -7501, 4872, 0, 0, 0, 0x00000000, bhvBMMusic1),
		...
		OBJECT(MODEL_NONE, -5508, -7501, 3535, 0, 0, 0, 0x00000000, bhvBMMusic3),
		OBJECT(MODEL_SIMPLE, -4941, -7518, 2768, 0, -180, 0, 0x00000000, bhvSimple),
		OBJECT(MODEL_NONE, -5021, -7518, 2727, 0, -90, 0, EX_SIMPLE << 16, bhvSignOnWall),
	...
	AREA(4, sa_area_4),
		WARP_NODE(0x02, LEVEL_SA, 0x04, 0x02, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_CASTLE, 0x01, 0x27, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_CASTLE, 0x01, 0x28, WARP_NO_CHECKPOINT),
		INSTANT_WARP(0x00, 0x03, -2225, -7743, 3245),
		OBJECT(MODEL_NONE, -6310, 543, -2535, 0, -90, 0, 0x00020000, bhvPaintingDeathWarp),
		OBJECT(MODEL_CHEESE_FOLLOW, 6830, 131, 5783, 0, -90, 0, 0x00000000, bhvCheeseFollow),
		OBJECT(MODEL_GREMLIN_NM, -5944, 638, 881, 0, -90, 0, 0x00000000, bhvGremlin),
		OBJECT(MODEL_GREMLIN_NM, -5944, 638, -1595, 0, -90, 0, 0x00000000, bhvGremlin),
		OBJECT(MODEL_NONE, 3194, 432, 2042, 0, 0, 0, 0x00000000, bhvHiddenRedCoinStar),
		OBJECT(MODEL_NONE, 3194, 214, 2042, 0, 0, 0, 0x00000000, bhvRedCoinStarMarker),
		OBJECT(MODEL_TREE_MS_NM, 951, 131, 2657, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_TREE_MS_NM, -2062, 131, 4112, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_TREE_MS_NM, -5496, 131, 3837, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_TREE_MS_NM, -5495, 131, -3209, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_TREE_MS_NM, -2878, 131, -3917, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_TREE_MS_NM, 2641, 131, -2501, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_TREE_MS_NM, 3774, 131, -1010, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_TREE_MS_NM, 5211, 131, 1493, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_TREE_MS_NM, 6681, 131, 4663, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_TREE_MS_NM, 5926, 131, 5790, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_TREE_MS_NM, -4020, 131, 5286, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_TREE_MS_NM, -4047, 131, -1, 0, 0, 0, 0x00000000, bhvTree),
		MARIO_POS(0x01, -135, 6622, 200, 5568),
		TERRAIN(sa_area_4_collision),
		MACRO_OBJECTS(sa_area_4_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_MS_NIGHTMARE),
		TERRAIN_TYPE(TERRAIN_STONE),
		/* Fast64 begin persistent block [area commands] */
		/* Fast64 end persistent block [area commands] */
	END_AREA(),
