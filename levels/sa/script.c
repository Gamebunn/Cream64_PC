...
const LevelScript level_sa_entry[] = {
	...
	AREA(3, sa_area_3),
		...
		OBJECT(MODEL_NONE, -5475, -7569, 4756, 0, 0, 0, 0x00000000, bhvDDRMusic3),
		OBJECT(MODEL_SIMPLE, -5504, -7518, 4103, 0, -90, 0, 0x00000000, bhvSimple),
		OBJECT(MODEL_NONE, -5545, -7518, 4182, 0, 0, 0, EX_SIMPLE << 16, bhvSignOnWall),
