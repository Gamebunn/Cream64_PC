...
const LevelScript level_cotmc_entry[] = {
	...
	AREA(2, cotmc_area_2),
		...
		OBJECT(MODEL_NONE, 956, -4695, 2776, 0, 0, 0, 0x00F30000, bhvWarp),
		OBJECT(MODEL_NONE, 1125, -4695, 2666, 0, 0, 0, 0x00F30000, bhvWarp),
		OBJECT(MODEL_NONE, 1291, -4695, 2555, 0, 0, 0, 0x00F30000, bhvWarp),
		OBJECT(MODEL_NONE, 1464, -4695, 2441, 0, 0, 0, 0x00F30000, bhvWarp),
		OBJECT(MODEL_NONE, 956, -4900, 2776, 0, 0, 0, 0x00F30000, bhvWarp),
		OBJECT(MODEL_NONE, 1125, -4900, 2666, 0, 0, 0, 0x00F30000, bhvWarp),
		OBJECT(MODEL_NONE, 1291, -4900, 2555, 0, 0, 0, 0x00F30000, bhvWarp),
		OBJECT(MODEL_NONE, 1464, -4900, 2441, 0, 0, 0, 0x00F30000, bhvWarp),
