...
const LevelScript level_cotmc_entry[] = {
	...
	AREA(2, cotmc_area_2),
		...
		OBJECT(MODEL_NONE, 956, 549, 2776, 0, 0, 0, 0x00F30000, bhvWarp),
		OBJECT(MODEL_NONE, 1125, 549, 2666, 0, 0, 0, 0x00F30000, bhvWarp),
		OBJECT(MODEL_NONE, 1291, 549, 2555, 0, 0, 0, 0x00F30000, bhvWarp),
		OBJECT(MODEL_NONE, 1464, 549, 2441, 0, 0, 0, 0x00F30000, bhvWarp),
		OBJECT(MODEL_NONE, 956, 344, 2776, 0, 0, 0, 0x00F30000, bhvWarp),
		OBJECT(MODEL_NONE, 1125, 344, 2666, 0, 0, 0, 0x00F30000, bhvWarp),
		OBJECT(MODEL_NONE, 1291, 344, 2555, 0, 0, 0, 0x00F30000, bhvWarp),
		OBJECT(MODEL_NONE, 1464, 344, 2441, 0, 0, 0, 0x00F30000, bhvWarp),
