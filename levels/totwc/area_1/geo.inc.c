...
const GeoLayout totwc_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 0, 2285, 0, totwc_dl_clouds_mesh_layer_5),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, totwc_dl_level_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_ALPHA, totwc_dl_level_mesh_layer_4),
		GEO_DISPLAY_LIST(LAYER_ALPHA, totwc_dl_No_Collision_mesh_layer_4),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, totwc_dl_No_Collision_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
