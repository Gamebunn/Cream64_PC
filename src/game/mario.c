...
s32 execute_mario_action(UNUSED struct Object *o) {
  ...
  case 40: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_TERRY]; break;
  case 41: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MARIA]; break;
  case 42: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_RICHTER]; break; 
  case 43: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CHARLOTTE]; break; 
  case 44: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_GOEMON]; break; 
  case 45: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MIMI]; break;
  case 46: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_OUENDAN]; break;
  case 47: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PEPPINO]; break; 
  case 48: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_AVGN]; break; 
  case 49: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SORA]; break; 
  case 50: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_KAIRI]; break;
  case 51: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PARAPPA]; break;
  case 52: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_VANNY]; break;
  case 53: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MADOTSUKI]; break;
  case 54: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ARLE]; break;
  case 55: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DAWN]; break;
  case 56: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SERENA]; break;
  case 57: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DQHERO]; break;
  case 58: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MAGE]; break;
  case 59: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SYBIL]; break;
  case 60: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MIKU]; break;
  case 61: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_WONDER]; break;
  case 62: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SENA]; break;
  case 63: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_OLIMAR]; break;
  case 64: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PIT]; break;
  case 65: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_RIBBON]; break;
  case 66: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ANYA]; break;
  ...
  case 71: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_GOKU]; break;
  case 72: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PAN]; break; 
  case 73: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_NEZUKO]; break;
  case 74: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_YUGI]; break;
  case 75: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CREAM]; break;
  case 76: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SAKURA]; break;
  case 77: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_AUSTIN]; break;
  case 78: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_POMNI]; break;
...
if (gMarioState->action == ACT_HOVERING) {
  ...
  case 40: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_TERRY]; break;
  case 41: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MARIA_FLY]; break;
  case 42: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_RICHTER_FLY]; break; 
  case 43: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CHARLOTTE_FLY]; break; 
  case 44: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_GOEMON_FLY]; break; 
  case 45: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MIMI_FLY]; break;
  case 46: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_OUENDAN_FLY]; break;
  case 47: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PEPPINO_FLY]; break; 
  case 48: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_AVGN_FLY]; break; 
  case 49: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SORA_FLY]; break; 
  case 50: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_KAIRI_FLY]; break;
  case 51: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PARAPPA]; break;
  case 52: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_VANNY_FLY]; break;
  case 53: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MADOTSUKI_FLY]; break;
  case 54: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ARLE_FLY]; break;
  case 55: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DAWN]; break;
  case 56: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SERENA]; break;
  case 57: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DQHERO_FLY]; break;
  case 58: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MAGE]; break;
  case 59: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SYBIL_FLY]; break;
  case 60: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MIKU_FLY]; break;
  case 61: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_WONDER_FLY]; break;
  case 62: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SENA_FLY]; break;
  case 63: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_OLIMAR]; break;
  case 64: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PIT_FLY]; break;
  case 65: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_RIBBON_FLY]; break;
  case 66: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ANYA_FLY]; break;
  ...
  case 71: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_GOKU_FLY]; break;
  case 72: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PAN_FLY]; break; 
  case 73: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_NEZUKO_FLY]; break;
  case 74: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_YUGI_FLY]; break;
  case 75: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CREAM_FLY]; break;
  case 76: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SAKURA_FLY]; break;
  case 77: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_AUSTIN_FLY]; break;
  case 78: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_POMNI]; break;
