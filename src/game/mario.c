...
break;
  case 10: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO];
break;
  case 11: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO];
break;
  case 12: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO];
break;
  case 13: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO];
break;
  case 14: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_BEAN];
break;
  case 15: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MARIO];
break;
  case 16: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_LUFFY];
break;
  case 17: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ICHIBAN];
break;
  case 18: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_KLONOA];
break;
  case 19: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_TRAVIS];
break;  
  case 20: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ANYA];
break;
  case 21: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_JACK];
break;
  case 22: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_AUSTIN];
break;
  case 23: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DUDLEY];
break;
  case 24: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PAN];
break;
  case 25: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_LAN];
break;
  case 26: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ROGER];
break;
  case 27: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_GOKU];
break;
  case 28: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CINNIA];
break;
  case 29: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CHEF];
break;
  case 30: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_VAL];
break;
  case 31: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CREAMOCCHIA];
break;
  case 32: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_WIZ];
break;
  case 33: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_BAIT];
break;
  case 34: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CAROLINE];
break;
  case 35: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MACER];
break;
  case 36: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_POCKY];
break;
  case 37: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DANI];
break;
  case 38: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_KITTEN];
break;
  case 39: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_LAYLA];
break;
  case 40: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_KATALINA];
break;
...
break;
  case 10: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_FLY];
break;
  case 11: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_FLY];
break;
  case 12: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_FLY];
break;
  case 13: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_FLY];
break;
  case 14: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_BEAN_FLY];
break;
  case 15: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MARIO];
break;
  case 16: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_LUFFY];
break;
  case 17: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ICHIBAN_FLY];
break;
  case 18: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_KLONOA];
break;
  case 19: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_TRAVIS_FLY];
break;  
  case 20: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ANYA_FLY];
break;
  case 21: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_JACK_FLY];
break;
  case 22: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_AUSTIN_FLY];
break;
  case 23: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DUDLEY_FLY];
break;
  case 24: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PAN_FLY];
break;
  case 25: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_LAN_FLY];
break;
  case 26: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ROGER_FLY];
break;
  case 27: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_GOKU_FLY];
break;
  case 28: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CINNIA];
break;
  case 29: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CHEF_FLY];
break;
  case 30: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_VAL];
break;
  case 31: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CREAMOCCHIA];
break;
  case 32: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_WIZ_FLY];
break;
  case 33: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_BAIT];
break;
  case 34: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CAROLINE_FLY];
break;
  case 35: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MACER_FLY];
break;
  case 36: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_POCKY_FLY];
break;
  case 37: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DANI_FLY];
break;
  case 38: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_KITTEN];
break;
  case 39: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_LAYLA];
