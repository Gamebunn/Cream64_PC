...
s32 execute_mario_action(UNUSED struct Object *o) {
  ...
  case 0: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO];break;
  case 1: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_RIDERS]; break;
  case 2: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_WINTER]; break;
  case 3: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SPRING]; break;
  case 4: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_UNICORN]; break;
  case 5: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_YUKATA]; break;
  case 6: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SWIMSUIT]; break;
  case 7: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_HALLOWEEN]; break;
  case 8: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_JUNIHITOE]; break;
  case 9: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PRINCESS]; break;
  case 10: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DETECTIVE]; break;
  case 11: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DRUMMER]; break;
  case 12: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_LUNAR]; break;

  case 13: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_VANILLA]; break;
  case 14: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_AMY]; break;
  case 15: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_BLAZE]; break;
  case 16: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MARINE]; break;
  case 17: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SHADOW]; break;
  case 18: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SILVER]; break;
  case 19: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_TAILS]; break;
  case 20: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CHARMY]; break;
  ...
  case 27: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DAISY]; break;
  case 28: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_KLONOA]; break;
  case 29: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ENGIE]; break;
  case 30: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ICHIBAN]; break;
  case 31: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_TRAVIS]; break; 
  case 32: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_JACK]; break;
  case 33: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SFSAKURA]; break;
  case 34: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DUDLEY]; break;
  case 35: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_LUKE]; break;
  case 36: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ROLL]; break;
  case 37: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MMX]; break;
  case 38: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_LAN]; break; 
  case 39: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_VIRGIL]; break;
  case 40: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MARIA]; break;
  case 41: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_RICHTER]; break; 
  case 42: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CHARLOTTE]; break; 
  case 43: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_GOEMON]; break; 
  case 44: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MIMI]; break;
  case 45: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_OUENDAN]; break;
  case 46: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PEPPINO]; break; 
  case 47: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_AVGN]; break; 
  case 48: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SORA]; break; 
  case 49: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_KAIRI]; break;
  case 50: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PARAPPA]; break;
  case 51: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_VANNY]; break;
  case 52: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MADOTSUKI]; break;
  case 53: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ARLE]; break;
  case 54: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DAWN]; break;
  case 55: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SERENA]; break;
  case 56: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DQHERO]; break;
  case 57: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MAGE]; break;
  case 58: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SYBIL]; break;
  case 59: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MIKU]; break;
  case 60: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_WONDER]; break;
  case 61: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SENA]; break;
  case 62: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_OLIMAR]; break;
  case 63: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PIT]; break;
  case 64: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_RIBBON]; break;
  case 65: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_GOKU]; break;
  case 66: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PAN]; break; 
  case 67: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_RUKIA]; break;
  case 68: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_KARIYA]; break;
  case 69: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_LUFFY]; break;
  case 70: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CARROT]; break;
  case 71: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ANYA]; break;
  case 72: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_NEZUKO]; break;
  case 73: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_YUGI]; break;
  case 74: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CREAM]; break;
  case 75: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SAKURA]; break;
  case 76: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_AUSTIN]; break;
  case 77: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_POMNI]; break;
  case 78: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ROGER]; break;

  case 79: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CREAMOCCHIA]; break;
  case 80: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_LATINA]; break;
  case 81: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CHEF]; break;
  case 82: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_VAL]; break;
  case 83: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_TAMMIE]; break;
  case 84: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CACEE]; break;
  case 85: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_KATE]; break;
  case 86: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_KZ]; break;
  case 87: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_BAIT]; break;
  case 88: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_WIZ]; break;
  case 89: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_LILY]; break;
  case 90: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CAROLINE]; break;
  case 91: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_POCKY]; break;
  case 92: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PASTEL]; break;
  case 93: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DINA]; break;
  case 94: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MACER]; break;
  case 95: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MAGENTA]; break;
  case 96: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SWEET]; break;
  case 97: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CRESCENTFOX]; break;
  case 98: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DANI]; break;
  case 99: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_JOHNNY]; break;
  case 100: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DOT]; break;
  
  case 101: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_KITTEN]; break;
  case 102: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_LAYLA]; break;
  case 103: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_KATALINA]; break;
...
if (gMarioState->action == ACT_HOVERING) {
  switch (gMarioState->currentCostume) {
  case 0: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_FLY];break;
  case 1: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_RIDERS_FLY]; break;
  case 2: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_WINTER_FLY]; break;
  case 3: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SPRING_FLY]; break;
  case 4: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_UNICORN_FLY]; break;
  case 5: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_YUKATA_FLY]; break;
  case 6: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SWIMSUIT_FLY]; break;
  case 7: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_HALLOWEEN_FLY]; break;
  case 8: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_JUNIHITOE_FLY]; break;
  case 9: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PRINCESS_FLY]; break;
  case 10: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DETECTIVE_FLY]; break;
  case 11: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DRUMMER_FLY]; break;
  case 12: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_LUNAR_FLY]; break;

  case 13: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_VANILLA_FLY]; break;
  case 14: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_AMY_FLY]; break;
  case 15: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_BLAZE_FLY]; break;
  case 16: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MARINE_FLY]; break;
  case 17: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SHADOW]; break;
  case 18: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SILVER_FLY]; break;
  case 19: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_TAILS]; break;
  case 20: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CHARMY]; break;
  case 21: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_TIKAL_FLY]; break;
  case 22: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_COSMO_FLY]; break;
  case 23: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_EGGMAN_FLY]; break;
  case 24: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_BEAN]; break;
  case 25: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_NIGHTS_FLY]; break;

  case 26: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MARIO]; break;
  case 27: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DAISY_FLY]; break;
  case 28: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_KLONOA]; break;
  case 29: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ENGIE]; break;
  case 30: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ICHIBAN_FLY]; break;
  case 31: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_TRAVIS_FLY]; break; 
  case 32: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_JACK_FLY]; break;
  case 33: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SFSAKURA_FLY]; break;
  case 34: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DUDLEY_FLY]; break;
  case 35: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_LUKE_FLY]; break;
  case 36: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ROLL_FLY]; break;
  case 37: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MMX]; break;
  case 38: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_LAN_FLY]; break; 
  case 39: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_VIRGIL_FLY]; break;
  case 40: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MARIA_FLY]; break;
  case 41: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_RICHTER_FLY]; break; 
  case 42: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CHARLOTTE_FLY]; break; 
  case 43: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_GOEMON_FLY]; break; 
  case 44: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MIMI_FLY]; break;
  case 45: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_OUENDAN_FLY]; break;
  case 46: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PEPPINO_FLY]; break; 
  case 47: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_AVGN_FLY]; break; 
  case 48: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SORA_FLY]; break; 
  case 49: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_KAIRI_FLY]; break;
  case 50: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PARAPPA]; break;
  case 51: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_VANNY_FLY]; break;
  case 52: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MADOTSUKI_FLY]; break;
  case 53: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ARLE_FLY]; break;
  case 54: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DAWN]; break;
  case 55: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SERENA]; break;
  case 56: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DQHERO_FLY]; break;
  case 57: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MAGE]; break;
  case 58: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SYBIL_FLY]; break;
  case 59: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MIKU_FLY]; break;
  case 60: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_WONDER_FLY]; break;
  case 61: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SENA_FLY]; break;
  case 62: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_OLIMAR]; break;
  case 63: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PIT_FLY]; break;
  case 64: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_RIBBON_FLY]; break;
  case 65: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_GOKU_FLY]; break;
  case 66: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PAN_FLY]; break; 
  case 67: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_RUKIA_FLY]; break;
  case 68: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_KARIYA_FLY]; break;
  case 69: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_LUFFY]; break;
  case 70: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CARROT_FLY]; break;
  case 71: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ANYA_FLY]; break;
  case 72: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_NEZUKO_FLY]; break;
  case 73: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_YUGI_FLY]; break;
  case 74: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CREAM_FLY]; break;
  case 75: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SAKURA_FLY]; break;
  case 76: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_AUSTIN_FLY]; break;
  case 77: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_POMNI]; break;
  case 78: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_ROGER_FLY]; break;

  case 79: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CREAMOCCHIA]; break;
  case 80: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_LATINA_FLY]; break;
  case 81: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CHEF_FLY]; break;
  case 82: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_VAL]; break;
  case 83: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_TAMMIE_FLY]; break;
  case 84: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CACEE]; break;
  case 85: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_KATE_FLY]; break;
  case 86: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_KZ_FLY]; break;
  case 87: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_BAIT]; break;
  case 88: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_WIZ_FLY]; break;
  case 89: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_LILY_FLY]; break;
  case 90: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CAROLINE_FLY]; break;
  case 91: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_POCKY_FLY]; break;
  case 92: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_PASTEL_FLY]; break;
  case 93: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DINA]; break;
  case 94: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MACER_FLY]; break;
  case 95: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_MAGENTA_FLY]; break;
  case 96: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_SWEET_FLY]; break;
  case 97: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_CRESCENTFOX_FLY]; break;
  case 98: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DANI_FLY]; break;
  case 99: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_JOHNNY_FLY]; break;
  case 100: gMarioObject->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_MARIO_DOT]; break;
