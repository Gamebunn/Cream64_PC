...
break;
    case 19: obj2->header.gfx.sharedChild = gLoadedGraphNodes [MODEL_PEACH_CREAMOCCHIA];
break;
    case 20: obj2->header.gfx.sharedChild = gLoadedGraphNodes [MODEL_PEACH];
break;
    case 21: obj2->header.gfx.sharedChild = gLoadedGraphNodes [MODEL_PEACH_JACK];
break;
    case 22: obj2->header.gfx.sharedChild = gLoadedGraphNodes [MODEL_PEACH_MARK];
break;
