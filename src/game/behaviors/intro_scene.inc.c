...
break;
    case 22: obj2->header.gfx.sharedChild = gLoadedGraphNodes [MODEL_PEACH_CREAMOCCHIA];
break;
...
break;
    case 27: obj2->header.gfx.sharedChild = gLoadedGraphNodes [MODEL_PEACH_JACK];
break;
    case 28: obj2->header.gfx.sharedChild = gLoadedGraphNodes [MODEL_PEACH_MARK];
break;
    case 29: obj2->header.gfx.sharedChild = gLoadedGraphNodes [MODEL_PEACH_MARK];
break;
    }
