...
void bhv_cheese_act_follow_mario(void) {
  ...
  case 66: o->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_CHEESE_FOLLOW_ANYA]; break;
  ...
  case 71: o->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_CHEESE_FOLLOW_GOKU]; break;
  case 72: o->header.gfx.sharedChild = gLoadedGraphNodes[MODEL_CHEESE_FOLLOW_PAN]; break;  
