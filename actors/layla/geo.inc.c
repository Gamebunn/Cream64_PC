...
const GeoLayout layla_Armature_001[] = {
	GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, 0, 97, 0, 0, 0, 0),
	GEO_OPEN_NODE(),
		GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 0, 0, layla_0_Switch_Head_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
				...
				GEO_OPEN_NODE(),
					...
					GEO_OPEN_NODE(),
						...
						GEO_OPEN_NODE(),
							...
							GEO_BRANCH(1, layla_Armature_001),
						GEO_CLOSE_NODE(),
