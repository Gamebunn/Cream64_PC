...
const GeoLayout cheese_follow_pomni_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_SHADOW(1, 0, 80),
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 168, 0, cheese_follow_pomni_Root_mesh_layer_1),
				GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, cheese_follow_pomni_material_revert_render_settings),
	GEO_CLOSE_NODE(),
	GEO_END(),
};
