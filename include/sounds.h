...
#define SOUND_MARIO_GROUND_POUND_SUB             /* 0x24228080 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x41, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_MARIO_HERE_WE_GO_SENA              /* 0x24228080 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x42, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_MARIO_HERE_WE_GO_LAYLA             /* 0x24228080 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x43, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_MARIO_HERE_WE_GO_KITTEN            /* 0x24228080 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x44, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_MARIO_HERE_WE_GO_KATALINA          /* 0x24228080 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x45, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_MARIO_HERE_WE_GO_KLONOA            /* 0x24228080 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x46, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
#define SOUND_MARIO_BUH_BYE                      /* 0x24368080 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x40, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
#define SOUND_GENERAL_COIN_WATER                 /* 0x38128080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x11, 0x80, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE) // unverified
...
#define SOUND_GENERAL_COLLECT_1UP                /* 0x3058FF80 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x58, 0xFE, SOUND_DISCRETE)
...
#define SOUND_GENERAL_YOSHI_TALK                 /* 0x30703080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x70, 0xFF, SOUND_DISCRETE) // unverified
#define SOUND_GENERAL_SPLATTERING                /* 0x30713080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x71, 0x30, SOUND_DISCRETE) // unverified
#ifdef PORT_MOP_OBJS
#define SOUND_GENERAL_BOING3                     /* 0x30720000 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x72, 0x80, SOUND_DISCRETE) // unverified
#else
...
#define SOUND_GENERAL_PRESTO                     /* 0x30762080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x77, 0x20, SOUND_DISCRETE) // unverified
#define SOUND_OBJ_TAILS1                         /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x78, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ_TAILS2                         /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x79, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ_TAILS3                         /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x7A, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ_TAILS4                         /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x7B, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ_TAILS5                         /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x7C, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ_SAD_GARDEVOIR                  /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x7D, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ_POCKY                          /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x7E, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ_CHAO                           /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x7F, 0x40, SOUND_DISCRETE)
...
#ifdef PORT_MOP_OBJS
#define SOUND_OBJ_UNK23                          /* 0x50230000 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x23, 0x80, SOUND_DISCRETE) // unverified, unused
#else
...
#ifdef PORT_MOP_OBJS
#define SOUND_OBJ_EEL_HIGHPRIO                   /* 0x524A0080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x4A, 0x80, SOUND_VIBRATO | SOUND_DISCRETE)
#endif
...
#define SOUND_OBJ_BOWSER_PAIN                    /* 0x50050080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x75, 0x00, SOUND_DISCRETE)
#define SOUND_OBJ_BOWSER_SERIOUS                 /* 0x50050080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x76, 0x00, SOUND_DISCRETE)
#define SOUND_OBJ_EYEROK_OPENING                 /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x77, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ_EYEROK_DEATH                   /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x78, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ_KINGBOOMBOO                    /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x79, 0x40, SOUND_DISCRETE)
...
#define SOUND_OBJ_AMY1                           /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x11, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ_AMY2                           /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x12, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ_AMY3                           /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x13, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ_AMY4                           /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x14, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ_AMY5                           /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x15, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ_BLAZE1                         /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x16, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ_BLAZE2                         /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x17, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ_BLAZE3                         /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x18, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ_BLAZE4                         /* 0x50744080 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x19, 0x40, SOUND_DISCRETE)
...
#define SOUND_OBJ_LAYLA                          /* 0x50050080 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x22, 0x00, SOUND_DISCRETE)
...
#define SOUND_MENU_STAR_SOUND_AUSTIN             /* 0x701EFF80 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x3A, 0xFF, SOUND_DISCRETE)
