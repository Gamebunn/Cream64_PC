...
enum SeqId {
    ...
    SEQ_COLLECT_STAR_SORA,            // 0x51; COLLECT STAR (FOR SORA/KZ)
    SEQ_COLLECT_STAR_LAYLA,           // 0x52; COLLECT STAR (FOR LAYLA)
    SEQ_COLLECT_STAR_SWEET,           // 0x53; COLLECT STAR (FOR SWEET)
    SEQ_COLLECT_STAR_MMX,             // 0x54; COLLECT STAR (FOR MMX/DOT)
    SEQ_COLLECT_STAR_DANI,            // 0x55; COLLECT STAR (FOR DANI)
    SEQ_COLLECT_STAR_JHW,             // 0x56; COLLECT STAR (FOR JOHNNY)
    ...
    SEQ_COLLECT_STAR_KITTEN,          // 0x5A; COLLECT STAR (FOR KITTEN)
    SEQ_COUNT 
};
